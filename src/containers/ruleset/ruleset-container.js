...
import Rules from '../../components/decisions/decision';
...
const tabs = [{ name: 'Facts' }, { name: 'Rules' }, { name: 'Validate' }, { name: 'Generate' }];
    ...
    return <div>
      ...
      <div style={{height: '1200px'}}>
        ...
        <div className="tab-page-container">
          ...
          {this.state.activeTab === 'Rules' && <Rules decisions={indexedDecisions || []} attributes={attributes}
